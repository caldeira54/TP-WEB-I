    ...
    <div class="tabela">
        ...
        <table>
            ...
            foreach ($lista as $v) {
                ...
                echo '<td> <form action="./formEdicao.php" method="POST"> <input name="idFornecedor" type="hidden" value="' . $v['idFornecedor'] . '"/> <button class="botoesTd"> <img src="../css/imagens/editar.png"/> </button> </form></td>';
